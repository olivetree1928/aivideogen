...
-- 用户表：存储用户基本信息和登录相关数据
CREATE TABLE imaginevisual_users (
...
CREATE TABLE imaginevisual_credit_usage (
...
CREATE TABLE imaginevisual_effect (
...
INSERT INTO imaginevisual_effect (id, name, type, des, platform, link, api, is_open, link_name, credit, model, version, pre_prompt, created_at) VALUES (1, 'Kling v2.1', 1, NULL, 'replicate', 'https://replicate.com/kwaivgi/kling-v2.1/api', 'kwaivgi/kling-v2.1', 1, 'kling-v12', 15, 'kwaivgi/kling-v2.1', NULL, NULL, NULL);
INSERT INTO imaginevisual_effect (id, name, type, des, platform, link, api, is_open, link_name, credit, model, version, pre_prompt, created_at) VALUES (2, 'Flux1.1 Pro', 1, NULL, 'replicate', 'https://replicate.com/black-forest-labs/flux-1.1-pro', 'black-forest-labs/flux-1.1-pro', 1, 'flux-1-pro', 1, 'black-forest-labs/flux-1.1-pro', NULL, NULL, NULL);

-- 效果执行结果表：存储用户使用AI效果后的生成结果和相关信息
CREATE TABLE imaginevisual_effect_result (
...
CREATE TABLE imaginevisual_payment_history (
...
CREATE TABLE imaginevisual_subscription_plans (
...
CREATE TABLE imaginevisual_user_subscriptions (
