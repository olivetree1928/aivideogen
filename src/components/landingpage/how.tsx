      ...
      <div className="flex flex-col items-center w-full max-w-7xl px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
          <div className="md:w-1/2 relative pr-4">
            <p className="sm:text-xl mb-4 sm:mb-6 text-foreground">
              {t("how.description")}
            </p>
            <ol className="space-y-4 text-lg sm:text-xl text-foreground">
              <li className="flex items-center">
                <span className="mr-2 text-blue-700">
                  ✦
                </span>
                <h3 className="text-foreground">{t("how.item1")}</h3>
              </li>
              <li className="flex items-center">
                <span className="mr-2 text-blue-700">
                  ✦
                </span>
                <h3 className="text-foreground">{t("how.item2")}</h3>
              </li>
              <li className="flex items-center">
                  <span className="mr-2 text-blue-700">
                  ✦
                </span>
                <h3 className="text-foreground">{t("how.item3")}</h3>
              </li>
            </ol>
          </div>
