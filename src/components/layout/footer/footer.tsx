...
export default function Footer({ locale }: { locale: string }) {
  ...
  return (
    <footer className="flex w-full flex-col items-center text-foreground">
      <div className="max-w-7xl w-full px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-24 text-foreground mx-auto">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 md:pr-8">
            ...
            <p className="text-small text-foreground text-center xl:text-left">
              {t("description")}
            </p>
          </div>
          <div className="mt-16 grid grid-cols-1 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-4 md:gap-8">
              <div className="mt-10 md:mt-0">
                <p className="text-small font-semibold text-center xl:text-left text-foreground">
                  {t("recommend.title")}
                </p>
                <ul className="mt-6 space-y-4">
                  {footerNavigation.supportOptions.map((item) => (
                    <li key={item.name} className="text-center xl:text-left">
                      <Link className="text-foreground" href={item.href} size="sm">
                        {item.name}
                      </Link>
                    </li>
                  ))}
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul className="mt-6 space-y-4">
                  <li className="text-center xl:text-left">
                    ...
                    >
                      <Icon icon="mdi:email" className="text-foreground" /> :
